# R script to figures in "Hvor mange vil stemme på Nye Borgerlige? #8"
# Link: https://erikgahner.dk/2020/hvor-mange-vil-stemme-pa-nye-borgerlige-8/
...
polls_nb <- polls %>%
  filter(date > as.Date("2019-12-31") & date < as.Date("2020-05-14"))
...
ggsave("nyeborgerligeYouGov.png", width = 8, height = 5)